...
![Menu Mais Apps](./assets/passo1-apps.png)

### Passo 2: Habilitar Chat Interno

Localize o aplicativo **"Chat interno"** e clique em **habilitar**.

![Habilitar Chat Interno](./assets/passo2-habilitar.png)
...
![Configurar e Salvar](./assets/passo3-salvar.png)
...
![Conversa no Chat](./assets/conversa-chat.png)
...
![Configurar Chat Interno](./assets/desativar-configurar.png)
...
![Desabilitar e Salvar](./assets/desativar-salvar.png)
