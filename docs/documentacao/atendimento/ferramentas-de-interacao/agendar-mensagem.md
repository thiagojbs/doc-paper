...
![Menu de anexos - Agendar Mensagem](./assets/agendar-menu.png)
...
![Configuração do agendamento](./assets/agendar-config.png)
...
![Seleção de modelo de mensagem](./assets/agendar-modelo.png)
...
![Seleção de chatbot](./assets/agendar-chatbot.png)
...
![Histórico de agendamentos](./assets/agendar-historico.png)
