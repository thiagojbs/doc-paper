...
Verifique se a opção de **Encaminhamento de conversas** está ativa.

![Encaminhamento de conversas](/images/erros-e-problemas/instagram-09.png)

## Passo 10: Verificar app padrão

Verifique se o app padrão de mensagens está configurado corretamente.
